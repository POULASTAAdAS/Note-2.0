...
object Constants {
    ...
    const val BASE_URL = "https://8e2b-103-192-119-101.ngrok-free.app"

    const val PREFERENCES_NAME = "appPreferences"

    const val PREFERENCES_SIGNED_IN_KEY = "preferencesSigningKey"
    const val PREFERENCES_JWT_TOKEN_OR_SESSION_TOKEN_KEY = "giveMeThatJwtTokenKeyOrCookieeeeeeeeeeeeeeeeeeee"
